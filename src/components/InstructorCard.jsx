...
export function InstructorCard({ instructor, onAssign, onVerifyLevel }) {
  const { full_name, disciplines, cert_level, meeting_zone, students } = instructor
  ...
  return (
    <div className="bg-slate-800 rounded-2xl p-4">
      ...
      {students.length === 0 ? (
        <p className="text-slate-600 text-sm text-center py-3">No students assigned</p>
      ) : (
